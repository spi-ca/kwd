...
Constraints:
- Edit only caller-assigned project files for the approved implementation scope.
- Do not touch secrets, credentials, or protected paths.
- Do not bypass guardrails, sandbox policy, or ambiguous tool blocks; stop and report the blocked or ambiguous action instead.
